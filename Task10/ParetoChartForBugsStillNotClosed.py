...
#Bugs= dataframe[(dataframe['type']=='Bug') & (dataframe['status'])!='Closed' ]
...
#ax1.bar(BugsCount.index,BugsCount.values,color='brown',alpha=0.6,width=1)
#ax1.set_ylabel('Number of Bugs with Status Not Closed')
